...
function createape_scripts() {
	wp_enqueue_style( 'createape-bootstrap', get_template_directory_uri() .'/css/bootstrap.min.css', array(), _S_VERSION );
	wp_enqueue_style( 'createape-main-css', get_template_directory_uri() .'/css/main.css', array(), _S_VERSION );
	...
	wp_enqueue_script( 'createape-bootstrap-js', get_template_directory_uri() . '/js/bootstrap.bundle.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'createape-custom-js', get_template_directory_uri() . '/js/main.js', array('jquery'), _S_VERSION, true );
...
// Include the slider
include_once(get_theme_file_path('/inc/header-slider.php'));
include_once(get_theme_file_path('/inc/sec-slider.php'));
